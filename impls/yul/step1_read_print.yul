object "step0_repl" {
    ...
    code {
        ...
        function execute(data_ptr) -> end_ptr, result_ptr {
            ...
            case 1 {
                ...
                case 1 {
                    // TODO sig length
                    // let arg1_ptr
                    // end_ptr, arg1_ptr := execute(add(data_ptr, 4))
                ...
                case 2 {
                    // TODO sig length
                    // let arg1_ptr, arg2_ptr
                    // end_ptr, arg1_ptr := execute(add(data_ptr, 4))
                    // end_ptr, arg2_ptr := execute(end_ptr)
            ...
            // if gt(func, 0) {
            //     // 0 * 111 * 0000000000000000000000000000
            //     if eq(and(sig, 1879048192), 0) {

            //     }

            //     if eq(and(sig, 1879048192), 0) {
            //         // eval pe argument daca nu are arg deja calculat
            //         // else, functia
            //         // _not(a)
            //         // _iszero(a)
            //         eval()
        ...
        // function executef(_data) {
        //     let sig := getFuncSig(_data)
        //     let arity := getFuncArity(_data)
        ...
        // function reader_next(reader_ptr) -> token {
        //     let pos := mload(reader_ptr)
        //     token := mload(pos)
        //     mstore(reader_peak, add(pos, 32))
        // }

        // function reader_peak(reader_ptr) -> token {
        //     let pos := mload(reader_ptr)
        //     token := mload(pos)
        // }

        // function reader_str(reader_ptr) {
        //     // reader_tokenize -> Reader instance with tokens from string
        //     // read_from(Reader instance)
        // }

        // function reader_tokenize(str_ptr, blen) {
        //     // -> list tokens
        // }

        // function read_form() -> mal_ptr, mal_len {
